...
| 6 | **Indigenous data and CARE** — an entity for Arapaho, Cheyenne, and Ute land that speaks as if it owned the place | High / reputational | Medium | The twin's PRD §12 binds (§13); sensitivity gate inherited; encourage consultation as the entity grows, never require it; never speak for nations; sacred sites never referenced at precision |
