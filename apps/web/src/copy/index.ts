...
export const admin = {
  ...
  entities: "Entities",
  cols: { name: "kami", flags: "flags", guardDrop: "guard drop %", pulseSkip: "pulse skip %", consultation: "consultation", tokens7d: "tokens / 7 d" },
  paused: "paused",
  retired: "retired",
  consultationDone: "done",
  consultationPending: "pending",
  toggleConsultation: "Toggle consultation done",
  usage: "Usage tokens per day (last 14 days)",
  ...
  sb243Save: "Save date",
  cost: "Cost estimate",
  costLine: (tokens: number, usd: string) => `${tokens.toLocaleString()} tokens in 7 days ≈ ${usd} USD at config.card_hour_cost`,
