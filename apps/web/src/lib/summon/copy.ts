...
export const summon = {
  ...
  review: {
    ...
    consultationHeading: "Consultation (PRD §13 #4)",
    consultationIntro:
      "The Front Range is Arapaho, Cheyenne, and Ute country, and also Comanche, Kiowa, and Plains Apache. An entity for a place here consults the relevant Tribal offices before its page is published, and never speaks for nations.",
    consultationLabel: "Consultation record — who you have contacted, when, and what was said",
    consultationHelp: "Write what you know now. It is a record, not a form; a steward marks it done, and only then does the page publish.",
    consultationPending:
      "Your kami exists, its guardians are invited, and its page is NOT published. It stays unpublished until a steward marks the consultation record done.",
    consultationDone: (iso: string) => `Consultation marked done ${iso}. The page can publish.`,
    markDone: "Mark consultation done (steward)",
    created: "Summoned",
    createdBody: (name: string) => `${name} exists. Its binding is in review, its guardians are invited, and its page is unpublished until consultation is marked done.`,
